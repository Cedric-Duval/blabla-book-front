      ...
      <section id="hero-section" className="section">
        <div id="presentation">
          ...
          {isLogged && user?.firstname ? (
            <p>
              Bienvenue <strong>{user.firstname}</strong> dans l'univers des livres !
              Chaque page tournée est une nouvelle aventure. Découvrez, partagez,
              et vivez votre passion avec toute la communauté BlaBla Book.
            </p>
          ) : (
            <p>
              Bienvenue dans l'univers des livres où chaque page tournée est une
              nouvelle aventure. Rejoignez notre communauté de lecteurs passionnés,
              partagez vos coups de cœur et découvrez des trésors littéraires qui
              vous attendent. Ne restez pas seul avec vos livres !
            </p>
          )}
